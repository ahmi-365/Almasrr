...
export default function CreateParcelScreen() {
  ...
  const discountAmount = useMemo(
    () => (isPromoApplied && discountInfo ? discountInfo.discount_value : 0),
    [isPromoApplied, discountInfo]
  );
            ...
            <View style={styles.promoContainer}>
              ...
              {!isPromoApplied ? (
                <TouchableOpacity
                  style={[
                    styles.promoButton,
                    (!promoCode.trim() || !selectedCityData || isApplyingPromo) && styles.disabledButton,
                  ]}
                  onPress={handleApplyPromoCode}
                  disabled={!promoCode.trim() || !selectedCityData || isApplyingPromo}
                >
                  {isApplyingPromo ? (

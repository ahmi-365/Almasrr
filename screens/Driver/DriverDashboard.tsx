...
const PROMO_SLIDER_DATA = [
  {
    title: "تتبع مسار التوصيل",
    description: "إدارة مهام التوصيل بكفاءة وسهولة.",
    icon: Truck,
    color: "#3498DB",
  },
  {
    title: "إحصائيات الأداء",
    description: "تتبع إحصائيات التوصيل والعائدات.",
    icon: BarChart,
    color: "#2ECC71",
  },
  {
...
// Driver-specific card definitions
const CARD_DEFINITIONS = [
  { label: 'الطرد المعين', icon: ClipboardList, iconColor: '#3498DB', progressColor: '#2980B9' },
  { label: 'الطرود المسلمة', icon: CheckCircle, iconColor: '#27AE60', progressColor: '#2ECC71' },
    ...
    <View style={styles.container}>
      ...
      >
        <TouchableOpacity 
          ...
          activeOpacity={0.95}
          onPress={() => {
            Alert.alert('الرصيد في المحفظة', `الرصيد الحالي: ${dcBalance} د.ل`);
          }}
        >
